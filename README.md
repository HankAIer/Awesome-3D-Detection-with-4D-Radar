...
|       V2X-R        |              4D Radar,LiDAR, Camera (simulated)              |     PC      |  25'CVPR  |        3D bbox        | [github](https://github.com/ylwhxht/V2X-R) [paper](https://arxiv.org/pdf/2411.08402) | V2X-R contains 12,079 scenarios with 37,727 frames of LiDAR and 4D radar point clouds, 150,908 images |
...
|  MAN TruckScenes   |        6 4D Radars, 4 Cameras, 6 LiDAR, 1 GNSS, 2 IMU        |     PC      | 24'NeurIPS |        3D bbox        | [website](https://brandportal.man/d/QSf8mPdU5Hgj) [paper](https://arxiv.org/pdf/2407.07462v2) | Bounding boxes are available for 27 object classes, 15 attributes, and a range of more than 230 m. |
